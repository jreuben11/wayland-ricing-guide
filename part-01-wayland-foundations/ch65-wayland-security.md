...
- [Overview](#overview)
- [65.1 The X11 Security Problem](#651-the-x11-security-problem)
  - [Practical Demonstration of X11 Keylogging](#practical-demonstration-of-x11-keylogging)
- [65.2 Wayland's Isolation Model](#652-waylands-isolation-model)
  - [What the Isolation Does Not Cover](#what-the-isolation-does-not-cover)
- [65.3 Screenshot and Screen Capture Permissions](#653-screenshot-and-screen-capture-permissions)
  - [Core Protocol Level](#core-protocol-level)
  - [zwlr-screencopy-v1 (wlroots protocol)](#zwlr-screencopy-v1-wlroots-protocol)
  - [ext-image-capture-source-v1 (standardized, 2024)](#ext-image-capture-source-v1-standardized-2024)
  - [XDG Desktop Portal (for sandboxed apps)](#xdg-desktop-portal-for-sandboxed-apps)
  - [hyprland-toplevel-export-v1](#hyprland-toplevel-export-v1)
- [65.4 Input Isolation](#654-input-isolation)
  - [Keyboard Event Routing](#keyboard-event-routing)
  - [Global Shortcuts (the right way)](#global-shortcuts-the-right-way)
  - [Input Inhibitor Protocol](#input-inhibitor-protocol)
  - [What Wayland Input Isolation Prevents](#what-wayland-input-isolation-prevents)
- [65.5 The XWayland Security Perimeter](#655-the-xwayland-security-perimeter)
  - [What XWayland Reintroduces](#what-xwayland-reintroduces)
  - [What XWayland Isolates](#what-xwayland-isolates)
  - [Practical Implications](#practical-implications)
  - [Disabling XWayland](#disabling-xwayland)
- [65.6 Session Locking: ext-session-lock-v1](#656-session-locking-ext-session-lock-v1)
  - [Protocol Security Properties](#protocol-security-properties)
  - [Setting Up a Session Locker](#setting-up-a-session-locker)
  - [Lock on Suspend](#lock-on-suspend)
- [65.7 Compositor as Security Policy Enforcer](#657-compositor-as-security-policy-enforcer)
  - [Protocol Advertisement Policy](#protocol-advertisement-policy)
  - [Pointer Constraints](#pointer-constraints)
  - [Input Inhibitor Exclusivity](#input-inhibitor-exclusivity)
  - [Auditing Compositor Wayland Connections](#auditing-compositor-wayland-connections)
- [65.8 Flatpak and Wayland Sandboxing](#658-flatpak-and-wayland-sandboxing)
  - [Flatpak Sandbox + Wayland Integration](#flatpak-sandbox-wayland-integration)
  - [Portal Permission Management](#portal-permission-management)
  - [Portal Configuration File](#portal-configuration-file)
  - [Flatpak for Security-Sensitive Apps](#flatpak-for-security-sensitive-apps)
- [65.9 Network Isolation with Bubblewrap and Namespaces](#659-network-isolation-with-bubblewrap-and-namespaces)
  - [Bubblewrap Basics](#bubblewrap-basics)
  - [Binding the Wayland Socket](#binding-the-wayland-socket)
  - [wp-security-context-v1 (2024+)](#wp-security-context-v1-2024)
- [65.10 Hardening Checklist and Configuration](#6510-hardening-checklist-and-configuration)
  - [Environment Variables for Native Wayland](#environment-variables-for-native-wayland)
  - [Verifying Apps are Running Native Wayland](#verifying-apps-are-running-native-wayland)
- [65.11 Remaining Limitations and Known Attack Surfaces](#6511-remaining-limitations-and-known-attack-surfaces)
  - [Protocol-Level Gaps](#protocol-level-gaps)
  - [XWayland Remains the Weak Link](#xwayland-remains-the-weak-link)
  - [Clipboard Security](#clipboard-security)
  - [Compositor Trust (TCB)](#compositor-trust-tcb)
  - [Future Work: wp-security-context-v1](#future-work-wp-security-context-v1)
- [Troubleshooting](#troubleshooting)
  - [Portal Not Working (No Permission Dialog for Flatpak Apps)](#portal-not-working-no-permission-dialog-for-flatpak-apps)
  - [Session Lock Not Engaging](#session-lock-not-engaging)
  - [XWayland Apps Not Getting Keyboard Input](#xwayland-apps-not-getting-keyboard-input)
  - [grim / Screencopy Not Working](#grim-screencopy-not-working)
  - [Flatpak App Not Sandboxed Correctly](#flatpak-app-not-sandboxed-correctly)
