...
- [Overview](#overview)
- [8.1 History and Philosophy](#81-history-and-philosophy)
- [8.2 Installation](#82-installation)
  - [Arch Linux](#arch-linux)
  - [NixOS](#nixos)
  - [Fedora / Ubuntu](#fedora-ubuntu)
  - [Building from Source](#building-from-source)
  - [NVIDIA Considerations](#nvidia-considerations)
  - [First Launch Checklist](#first-launch-checklist)
- [8.3 The hyprlang Configuration Language](#83-the-hyprlang-configuration-language)
  - [Monitor Directives](#monitor-directives)
  - [`general` Block](#general-block)
  - [`decoration` Block](#decoration-block)
  - [`animations` Block](#animations-block)
  - [`input` Block](#input-block)
  - [`misc` Block](#misc-block)
- [8.4 Layout Algorithms](#84-layout-algorithms)
  - [Dwindle Layout](#dwindle-layout)
  - [Master Layout](#master-layout)
  - [hyprscroller Plugin](#hyprscroller-plugin)
- [8.5 Window Rules and Layer Rules](#85-window-rules-and-layer-rules)
  - [windowrulev2 Syntax](#windowrulev2-syntax)
  - [layerrule](#layerrule)
- [8.6 Keybindings and Dispatchers](#86-keybindings-and-dispatchers)
  - [Complete Keybinding Configuration](#complete-keybinding-configuration)
  - [Submaps (Modal Keybinding Layers)](#submaps-modal-keybinding-layers)
- [8.7 Animations](#87-animations)
  - [Bezier Curve Definitions](#bezier-curve-definitions)
  - [Animation Declarations](#animation-declarations)
  - [Performance Tuning](#performance-tuning)
- [8.8 Hyprland IPC](#88-hyprland-ipc)
  - [hyprctl Reference](#hyprctl-reference)
  - [Event Socket Scripting](#event-socket-scripting)
  - [Python Integration with pyprland](#python-integration-with-pyprland)
- [8.9 The Plugin Ecosystem](#89-the-plugin-ecosystem)
  - [hyprpm Workflow](#hyprpm-workflow)
  - [Notable Plugins](#notable-plugins)
  - [hyprexpo Configuration](#hyprexpo-configuration)
- [8.10 Hyprland Utilities](#810-hyprland-utilities)
  - [hyprpaper](#hyprpaper)
  - [hyprlock](#hyprlock)
  - [hypridle](#hypridle)
  - [hyprshot](#hyprshot)
  - [hyprsunset](#hyprsunset)
- [8.11 Configuration Gallery](#811-configuration-gallery)
  - [Minimal + Fast Config](#minimal-fast-config)
  - [Heavy Eye-Candy Config (Catppuccin Mocha)](#heavy-eye-candy-config-catppuccin-mocha)
  - [NixOS home-manager Module](#nixos-home-manager-module)
- [8.12 Troubleshooting](#812-troubleshooting)
  - [Black Screen on Launch](#black-screen-on-launch)
  - [Screen Tearing / Flickering (NVIDIA)](#screen-tearing-flickering-nvidia)
  - [Apps Look Blurry on HiDPI](#apps-look-blurry-on-hidpi)
  - [Waybar / Status Bar Not Showing](#waybar-status-bar-not-showing)
  - [Hyprpm Plugin Fails to Compile](#hyprpm-plugin-fails-to-compile)
  - [Input Lag / High Latency Feel](#input-lag-high-latency-feel)
  - [Config Reload Errors](#config-reload-errors)
- [See Also](#see-also)
